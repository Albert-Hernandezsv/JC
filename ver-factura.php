  ...
  <section class="content-header">
    ...
    <?php
            if($factura["tipoDte"] === "04" || $factura["tipoDte"] === "05" || $factura["tipoDte"] === "06"){
                ...
                echo '<button class="btn btn-dark" onclick="location.href=\'extensiones/TCPDF-main/examples/imprimir-ticket.php?idFactura=' . $factura['id']. '\'" disabled>Generar ticket</button>
                    <button class="btn btn-secondary editarTicket" data-toggle="modal" data-target="#modalEditarTicket" disabled>Configuración ticket</button>';
            }
