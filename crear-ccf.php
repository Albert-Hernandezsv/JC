                                        ...
                                        <div class="row productoItem">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select name="nuevoIdProductoFactura[]" class="form-control select2 seleccionarProductoFactura" required readonly>
                                                            ...
                                                            echo '<option data-exento="' . $product["exento_iva"] . '" data-codigo="' . htmlspecialchars($product["codigo"], ENT_QUOTES, 'UTF-8') . '" data-value="' . $product["id"] . '" data-precio="' . $product["precio_venta"] . '">' . $product["nombre"] . ' - ' . htmlspecialchars($product["codigo"], ENT_QUOTES, 'UTF-8') . '</option>';
                                                            ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-2 col-xs-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="nuevoTotalProductoFacturaIndividual1[]" readonly value="<?php echo ($producto["precioSinImpuestos"] * $producto["cantidad"]); ?>">
                                                </div>
                                            </div>
